...
| 业务需求、催收策略、场景说明 | `docs/requirements/`目录下对应文档 |
| 系统架构、技术选型、模块设计 | `docs/design/`目录下对应文档 |
| 评估方案、测试用例、效果指标 | `docs/evaluation/`目录下对应文档 |
| 实验分析、数据报告、调研结果 | `docs/experiments/`目录下对应文档 |
| 核心功能说明、快速开始指南 | 根目录`README.md` |

### 更新要求
1. 讨论结论需要在24小时内更新到对应文档，确保信息同步
2. 更新时保持文档结构一致性，避免零散记录
3. 重大决策需要保留变更历史，可通过Git提交历史追溯
